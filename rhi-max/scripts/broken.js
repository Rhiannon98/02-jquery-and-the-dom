...
Article.prototype.toHtml = function () {
  ...
  //find() method
  $newArticle.find('h1').replaceWith(this.title);
  $newArticle.find('.article-body').replaceWith(this.body);
  $newArticle.find('address > a').replaceWith(`<a href = $(this.authorUrlx)>author</a>`);
  $newArticle.find('address > a').replaceWith(this.author);
